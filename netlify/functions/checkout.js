...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (targetPlan === 'capture')         depositAmount = 150000;
    else if (targetPlan === 'growth')     depositAmount = 300000;
    else if (targetPlan === 'sv-inicial') depositAmount = 30000;
    else if (targetPlan === 'sv-growth')  depositAmount = 80000;

    const isAudit = type === 'audit';
    const productName = isAudit
      ? 'Business Systems Audit - Deposit'
      : `Cresca OS - ${targetPlan.toUpperCase()} Setup`;
